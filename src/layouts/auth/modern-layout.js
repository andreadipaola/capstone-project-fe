      ...
      >
        <Box maxWidth="md">
          <Typography
            ...
            variant="h4"
          >
            Welcome to PandaRooms
          </Typography>
          <Typography
            color="text.secondary"
            sx={{ mb: 4 }}
          >
            Professionals in hotel management with twenty years of experience.          </Typography>
          <Typography
            variant="subtitle2"
            sx={{ mb: 2 }}
          >
            Join the 600+ establishments already using our product
          </Typography>
          <Stack
            alignItems="center"
            direction="row"
