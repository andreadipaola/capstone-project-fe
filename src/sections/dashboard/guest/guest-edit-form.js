...
export const GuestEditForm = (props) => {
  const { guest, ...other } = props;
  const formik = useFormik({
    initialValues: {
      ...
      email: guest.email || '',
      hasDiscount: guest.hasDiscount || false,
      isVerified: guest.isVerified || false,
      name: guest.name || '',
      phone: guest.phone || '',
      state: guest.state || '',
      submit: null
