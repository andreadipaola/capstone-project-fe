...
export const RoomTypeEditForm = (props) => {
  const { roomType, ...other } = props;
  const formik = useFormik({
    initialValues: {
      ...
      hasDiscount: roomType.hasDiscount || false,
      isVerified: roomType.isVerified || false,
      name: roomType.name || '',
  ...
  return (
    <form
      ...
      {...other}>
      <Card>
        <CardHeader title="Edit RoomType" />
        <CardContent sx={{ pt: 0 }}>
          <Grid
            container
            spacing={3}
